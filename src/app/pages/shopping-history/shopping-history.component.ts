...
import { shopping } from 'src/contants';
...
export class ShoppingHistoryComponent implements OnInit {
  ...
  productShopping:shopping[]=[
    {
      nameProduct:"Calcetines de compresion, Calcetines de compresion, Calcetines de compresion, Calcetines de compresion, Calcetines de compresion",
      price:"18000",
      idProduct:1,
      amount:3,
